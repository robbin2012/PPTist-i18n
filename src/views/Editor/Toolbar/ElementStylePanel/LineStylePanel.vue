<template>
  <div class="line-style-panel">
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.line.style') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.line.color') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.line.width') }}：</div>
      <NumberInput 
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.line.startMarker') }}：</div>
      <SelectCustom style="width: 60%;">
        <template #options>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.line.endMarker') }}：</div>
      <SelectCustom style="width: 60%;">
        <template #options>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="updateLine({ start: handleLineElement.end, end: handleLineElement.start })"><IconSwitch /> {{ t('toolbar.line.swapDirection') }}</Button>
    </div>
