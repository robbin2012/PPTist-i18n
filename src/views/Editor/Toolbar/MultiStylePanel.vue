<template>
  <div class="multi-style-panel">
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.multi.fillColor') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.multi.outlineStyle') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.multi.outlineColor') }}：</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('toolbar.multi.outlineWidth') }}：</div>
      <NumberInput 
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton first :color="richTextAttrs.color" v-tooltip="t('toolbar.text.fontColor')">
          <IconText />
        </TextColorButton>
      </Popover>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton :color="richTextAttrs.backcolor" v-tooltip="t('toolbar.text.highlight')">
          <IconHighLight />
        </TextColorButton>
      </Popover>
      <Button 
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="t('toolbar.text.alignLeft')"><IconAlignTextLeft /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="t('toolbar.text.alignCenter')"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="t('toolbar.text.alignRight')"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="t('toolbar.text.alignJustify')"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
  </div>
</template>
